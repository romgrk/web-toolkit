...
function AppHeader() {
  return (
    <HeaderBar titlebar>
      ...
      <HeaderBar.Title fill>Web Toolkit Demo</HeaderBar.Title>
      <DemoAutocomplete />
...
function DemoList() {
  ...
  const richItems = [
    ...
    <>
      <Label>Row 2</Label>
      <Range value={number} onChange={setNumber} style={{ width: 100 }} />
    </>,
    <>
      <Label>Row 3</Label>
    ...
    <>
      <Label>Row 4</Label>
      <Button icon='mail-mark-important' />
    </>,
    <>
      <Label>Row 5</Label>
      <Checkbox />
  ...
  const checkboxList = (
    <List style={{ width: 200 }} rich rounded>
      <List.Item activatable as='label'>
        <Radio defaultValue={true} name='settings-1' />{' '}
        <Label className='Box__fill'>Option 1</Label>
      </List.Item>
      <List.Item activatable as='label'>
        <Radio defaultValue={false} name='settings-1' />{' '}
        <Label className='Box__fill'>Option 1</Label>
      </List.Item>
      <List.Item activatable as='label'>
        <Radio defaultValue={false} name='settings-1' />{' '}
    ...
    <List style={{ width: 200 }} rich rounded>
      ...
      <Expander
        ...
        <List rich border={false} sublist>
          <List.Item activatable as='label'>
            <Radio defaultValue={true} name='settings-1' />{' '}
            <Label className='Box__fill'>Option 2.1</Label>
          </List.Item>
          <List.Item activatable as='label'>
            <Radio defaultValue={false} name='settings-1' />{' '}
            <Label className='Box__fill'>Option 2.2</Label>
          </List.Item>
          <List.Item activatable as='label'>
            <Radio defaultValue={false} name='settings-1' />{' '}
            <Label className='Box__fill'>Option 2.3</Label>
          </List.Item>
        </List>
      </Expander>
      <List.Item activatable as='label'>
      ...
      */}
      ...
      <Box horizontal>
        <Box horizontal compact border>
          ...
          <PageSwitcher transition={false} activePage={stackPage} pages={stackItems} />
        </Box>
        {richList}
      </Box>
    </>
  ...
  return (
    <>
      <Box horizontal expandChildren style={{ height: 200 }}>
        <Paned>
          <Box padded>
            Suscipit. Duis leo est, interdum nec, varius in, facilisis vitae, odio. Phasellus eget
            leo at urna adipiscing vulputate. Nam eu erat vel arcu tristique mattis. felis.
          </Box>
          <Box padded>
            Suspendisse sit amet tellus non odio porta pellentesque. Nulla facilisi. Integer iaculis
            condimentum augue. Nullam urna nulla, vestibulum quis, lacinia eget, ullamcorper eu,
            dui.
          </Box>
        </Paned>
      ...
      <Box horizontal expandChildren style={{ height: 200 }}>
        <Box vertical>
          ...
          <Expander label='View the paragraph'>
            ...
            Phasellus arcu tellus, ultricies id, consequat id, lobortis nec, diam. Suspendisse sed
            nunc. Pellentesque id magna. Morbi interdum quam at est. Maecenas eleifend mi in urna.
            Praesent et lectus.
          </Expander>
          After
        </Box>
  ...
  const pages = [
    {
      ...
      content: (
        <Box padded>
          Pharetra velit vitae eros. Vivamus ac risus. Mauris ac pede laoreet felis pharetra
          ultricies. Proin et neque. Aliquam dignissim placerat felis. Mauris porta ante sagittis
          purus. Nullam adipiscing eros.
        </Box>
      ),
    },
    {
      ...
      content: (
        <Box padded>
          Mattis odio vitae tortor. Fusce iaculis. Aliquam rhoncus, diam quis tincidunt facilisis,
          sem quam luctus augue, ut posuere neque sem vitae neque. Sed sed justo. Curabitur
          consectetuer arcu. Etiam placerat est eget odio. Nulla.
        </Box>
      ),
    },
    {
      ...
      content: (
        <Box padded>
          Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nunc
          faucibus posuere turpis. Sed laoreet, est sed gravida tempor, nibh enim fringilla quam, et
          dapibus mi enim sit amet risus. Nulla sollicitudin eros sit amet diam. Aliquam ante.
          Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Ut
          et est. Donec semper nulla in ipsum. Integer elit. In pharetra lorem vel ante.
        </Box>
      ),
    },
  ];
  ...
  const options = filteredUsers.map(u => ({
    ...
    label: (
      <Box compact horizontal>
        <Box.Fill style={{ minWidth: 200 }}>{u.name}</Box.Fill>
...
function DemoPopover({}) {
  const smallPopover = (
    <Popover
      ...
      <Button icon='audio-headphones'>Volume</Button>
    </Popover>
  );
  ...
  const hoverPopover = (
    <Popover
      ...
      <Button icon='input-mouse'>Hover Me</Button>
    </Popover>
  );
...
function DemoPopoverMenu({}) {
  ...
  const getPages = ({ change, close, back }) => [
    ...
    },
    {
      ...
      content: (
        <Menu icons>
          <Menu.Back onClick={back}>Share</Menu.Back>
  ...
  return (
    <PopoverMenu pages={getPages} open={open} onChangeOpen={setOpen}>
      <Button icon='emblem-system'>Open Popover</Button>
    </PopoverMenu>
  );
}
    ...
    <>
      <Box horizontal>
        <Box vertical style={{ width: 300 }}>
          <Input icon='folder-saved-search' iconAfter='edit-clear' placeholder='Text input...' />
          <Input icon={<Spinner />} iconAfter='edit-clear' value='Disabled' disabled />
...
function DemoButtons() {
  return (
    <Box>
      ...
      <div className='row'>
        <Button className='osd'>OSD Button</Button>
        <span className='StackSwitcher linked'>
          ...
          <Button text className='needs-attention'>
            <span className='Label'>Page 4</span>
          </Button>
        </span>
      </div>
    </Box>
    ...
    <>
      <Box vertical>
        {sizes.map(size => (
          <Box horizontal>
            <Input.Group>
              <Input size={size} iconAfter='edit-clear' placeholder='Text input...' />
...
function DemoInputFilter({ column: { filterValue, setFilter, id } }) {
  return <Input size='mini' id={id} value={filterValue} onChange={setFilter} />;
}
    ...
    },
    {
      ...
      columns: [
        ...
        },
        {
          Header: 'Address',
          accessor: row =>
            `${row.address.street}${row.address.suite ? ' ' + row.address.suite : ''}, ${
              row.address.city
            }`,
          disableFilters: true,
        },
...
function DemoDropdown({ users }) {
  ...
  return (
    <Box vertical>
      <Dropdown value={value} loading={users.length === 0} options={options} onChange={setValue} />
      <Dropdown
        input
        value={value}
        ...
        <MenuBar>
          <MenuBar.Button label='File'>
            <Menu>
              ...
              <Menu.Button menu={true}>Other</Menu.Button>
              <Menu.Separator />
              <Menu.Button accelerator='Ctrl+Q'>Quit</Menu.Button>
            </Menu>
          </MenuBar.Button>
...
function ComplexMenu({ onClickShare }) {
  return (
    <Menu icons>
      ...
      <Menu.Button radio name='size' value='small'>
        Small
      </Menu.Button>
      <Menu.Button radio name='size' value='medium'>
        Medium
      </Menu.Button>
      <Menu.Button radio name='size' value='large'>
        Large
      </Menu.Button>
      <Menu.Separator />
